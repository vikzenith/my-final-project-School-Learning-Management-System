"""bizmarrow_learning_system URL Configuration
...
from bizmarrow_learning_app import views, HodViews, StaffViews, StudentViews
from bizmarrow_learning_app.EditResultVIewClass import EditResultViewClass
from bizmarrow_learning_system import settings
...
urlpatterns = [
    ...
    path('admin_send_video_staff', HodViews.admin_send_video_staff,name="admin_send_video_staff"),
    path('admin_send_video_student', HodViews.admin_send_video_student,name="admin_send_video_student"),
    
    path('send_staff_video', HodViews.send_staff_video,name="send_staff_video"),
    path('send_student_video', HodViews.send_student_video,name="send_student_video"),
    ...
    # staff_all_video
    path('staff_all_video', StaffViews.staff_all_video, name="staff_all_video"),
    ...
    path('student_all_video', StudentViews.student_all_video, name="student_all_video"),

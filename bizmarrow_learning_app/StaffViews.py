...
# staff_all_video
def staff_all_video(request):
    staff=Staffs.objects.get(admin=request.user.id)
    videoz=VideoStaffs.objects.filter(staff_id=staff.id)
    return render(request,"staff_template/all_video.html", {"videoz":videoz})
...
def your_view(request):
    ...
    return render(request, 'staff_template/footer.html', context)
...
from bizmarrow_learning_app.models import *
...
# student_all_video
def student_all_video(request):
    student=Students.objects.get(admin=request.user.id)
    videoz=VideoStudents.objects.filter(student_id=student.id)
    return render(request,"student_template/all_student_video.html",{"videoz":videoz})
...
def your_view(request):
    ...
    return render(request, 'student_template/footer.html', context)